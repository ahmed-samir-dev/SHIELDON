...
namespace SHIELDON.Infrastructure.Migrations
{
    ...
    [Migration("20260806175250_AddAnnouncementDisplayOrder")]
    partial class AddAnnouncementDisplayOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SHIELDON.Domain.Entities.ConversationParticipant", b =>
                {
                    b.Property<Guid>("ConversationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SHIELDON.Domain.Entities.CourseDeleteAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CourseDeleteAuditLogs", (string)null);
                });
            ...
            modelBuilder.Entity("SHIELDON.Domain.Entities.ExamExtension", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("ExtendedEndTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SHIELDON.Domain.Entities.CourseDeleteAuditLog", b =>
                {
                    b.HasOne("SHIELDON.Domain.Entities.User", "DeletedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("SHIELDON.Domain.Entities.ExamExtension", b =>
                {
                    ...
                    b.HasOne("SHIELDON.Domain.Entities.ReattemptRequest", "SourceRequest")
                        .WithMany()
