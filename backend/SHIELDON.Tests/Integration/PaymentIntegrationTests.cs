...
public class PaymentIntegrationTests : IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    [Fact]
    public async Task GetPaymentHistory_UnauthorizedUser_ReturnsUnauthorized()
    {
        // Arrange
