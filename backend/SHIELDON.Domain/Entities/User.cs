...
public class User
{
    ...
    public PhoneVerificationStatus PhoneVerificationStatus { get; set; } = PhoneVerificationStatus.None;
    public DateTime? PhoneVerifiedAt { get; set; }

    // ── Phone OTP Tracking ─────────────────────────────────────
    /// <summary>UTC timestamp of the most recent OTP send. Used to enforce the 2-minute resend cooldown.</summary>
    public DateTime? PhoneOtpLastSentAt { get; set; }
    /// <summary>UTC expiry of the most recent OTP (10 minutes from send). Used for display purposes.</summary>
    public DateTime? PhoneOtpExpiresAt { get; set; }
    public int PhoneOtpFailedAttempts { get; set; } = 0;
    /// <summary>
    /// BCrypt hash of the currently active 6-digit OTP code.
    /// Generated by ProfileService on send, compared on verify.
    /// Null when no active OTP is pending or after successful verification.
    /// </summary>
    public string? PhoneOtpCodeHash { get; set; }
